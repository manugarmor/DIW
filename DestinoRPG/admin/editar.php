...
$sql=mysqli_query($con,"select * from jrpg where id='$id_banner' limit 0,1");
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="index_admin.php">Juego</a></li>
		  <li class="active">Editar</li>
		</ol>
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar juego</h3>
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 100%;" >
									  <img class="img-rounded" src="../img/juegos/<?php echo $url_image;?>" />
								  </div>
